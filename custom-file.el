...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (multiple-cursors projectile ample-theme pacmacs web-mode omnisharp csharp-mode solarized-theme cyberpunk-theme noctilux-theme use-package company tide)))
