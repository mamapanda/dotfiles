...
#+BEGIN_SRC emacs-lisp
  (use-package multiple-cursors
    :general
    (panda/general-leader "m" 'hydra-multiple-cursors/body)
    :config
...
#+BEGIN_SRC emacs-lisp
  (use-package flycheck
    :demand t
    :general
    (panda/general-leader "e" 'hydra-flycheck/body)
    :custom
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package ivy-yasnippet
    :after yasnippet
    :general
    (panda/general-leader "s" 'ivy-yasnippet))
#+END_SRC
* Language Modes
** Assembly
...
#+END_SRC
** C / C++
The ccls executable is expected to be at ~<user-emacs-directory>/ccls/build/ccls~.
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package ccls
    ...
    :custom
    (ccls-executable
     (expand-file-name "ccls/build/ccls" user-emacs-directory)))
